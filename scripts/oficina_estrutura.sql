...
CREATE TABLE IF NOT EXISTS `cad_clientes` (
  ...
  `NomeExibicao` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cad_clientes_indicacoes` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `Cliente_Id` bigint NOT NULL,
  `Indicador_Nome` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Indicador_Telefone` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Observacao` varchar(240) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Created_At` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `Updated_At` datetime(6) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `cad_clientes_pj` (
  ...
  `Nome_Fantasia` varchar(180) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cad_mecanicos` (
  ...
  `Nome` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Sobrenome` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Nome_Social` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Documento_Principal` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `Nivel` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pleno',
...
CREATE TABLE IF NOT EXISTS `cad_mecanicos_documentos` (
  ...
  `Data_Emissao` date DEFAULT NULL,
  `Data_Validade` date DEFAULT NULL,
  `Orgao_Expedidor` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cad_mecanicos_especialidades_rel` (
  ...
  `Nivel` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pleno',
  `Principal` tinyint(1) NOT NULL DEFAULT '0',
  `Anotacoes` varchar(240) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Created_At` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `Updated_At` datetime(6) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `cad_mecanicos_experiencias` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `Mecanico_Id` bigint NOT NULL,
  `Empresa` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Cargo` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Data_Inicio` date DEFAULT NULL,
  `Data_Fim` date DEFAULT NULL,
  `Resumo_Atividades` varchar(400) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Created_At` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `Updated_At` datetime(6) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(6),
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `cad_veiculos` (
  ...
  `Chassi` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Renavam` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `KM` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Combustivel` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Observacao` varchar(240) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Principal` tinyint(1) NOT NULL DEFAULT '0',
  `Ativo` tinyint(1) NOT NULL DEFAULT '1',
  `Created_At` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
